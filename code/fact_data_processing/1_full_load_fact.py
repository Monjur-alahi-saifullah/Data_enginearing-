...
df_default1 = spark.sql("SELECT * FROM fmcg.default.orders_2025_10_17")
df_default2 = spark.sql("SELECT * FROM fmcg.default.orders_2025_07_16")
df = df_default1.unionByName(df_default2)
display(df.show(12))
